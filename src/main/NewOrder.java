	...
	public NewOrder(String orderid, int indexneworder) throws IOException {
		addWindowListener(new WindowAdapter() {
			...
			public void windowClosed(WindowEvent e) {
				...
				for (int i = 0; i < Main.getorders().size(); i++) {
					System.out.println(Main.getorders().get(i));
				}
			}
		});
		...
		gl_panel_2.setVerticalGroup(gl_panel_2.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_2.createSequentialGroup().addGap(45).addComponent(lblNewLabel_1).addGap(18)
						.addComponent(lblNewLabel_3).addGap(34).addComponent(lblNewLabel_4)
		...
		gl_panel_1.setHorizontalGroup(gl_panel_1.createParallelGroup(Alignment.LEADING).addGroup(gl_panel_1
				...
				.addGroup(
						gl_panel_1.createParallelGroup(Alignment.LEADING)
								...
								.addComponent(btnNewButton, Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 88,
						...
						gl_panel_1.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_panel_1.createSequentialGroup().addGap(42)
										...
										.addComponent(textField_1, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
												GroupLayout.PREFERRED_SIZE)
										.addGap(28).addComponent(btnNewButton_1)
		...
		lblNewLabel_2 = new JLabel("Create new order for ID: " + orderid);
